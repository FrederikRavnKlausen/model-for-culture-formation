...
filepath = 'C:/Users/alaurits/Desktop/Data_borders_of_Europe/simulations_era=10_flux_varied_europe/alive_list_'
...
axins = zoomed_inset_axes(ax, 20, loc='upper left', 
    bbox_to_anchor=(0.4,0.78,.2,.5), bbox_transform=ax.transAxes)

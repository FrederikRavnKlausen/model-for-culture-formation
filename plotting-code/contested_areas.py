...
river_area_bonus = 6 # Added to area if controlling both sides of a river.
...
print(os.path.isfile(f'./Simulations/no_conquered_array_' + str(iteration_number)+str(era)+str(parameter_list)+'.npy'))

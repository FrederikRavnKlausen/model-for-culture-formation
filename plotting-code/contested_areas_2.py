...
print(os.path.isfile(f'./Simulations2/no_conquered_array_' + str(extended_parameter_list)+'.npy'))
...
firstca = np.load(f'./Simulations2/no_conquered_array_' + str(extended_parameter_list)+'.npy')
...
for k in range(N):
    ...
    no_conquered_array = np.load(f'./Simulations2/no_conquered_array_' + str(extended_parameter_list)+'.npy')
    for i in range(0,n):
        for j in range(0,m):
...
cur_country_array = np.load(f'./Simulations2/no_conquered_array_' + str(extended_parameter_list)+'.npy')
